...
const Experience = () => {
    ...
    return (
        <div name='experience' className='bg-gradient-to-b from-gray-100 to-gray-200 text-gray-800 md:h-screen pt-20'>
            <div data-aos="fade-left" className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full mt-32'>
                <div className='pb-8'>
