                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-8 md:px-12 px-0'>
                    {
                        portfolios.map(({ id, name, src, demo, code }) => <div key={id} className='shadow-md shadow-gray-600 rounded-lg'>
                            ...
                            <div className='flex  justify-center items-center'>
                                <a href={demo} target='_blank' rel="noreferrer" className='w-1/3 px-6 py-3 duration-200 hover:scale-105'>Live Website</a>
                                <a href={code} target='_blank' rel="noreferrer" className='w-1/3 px-6 py-3  duration-200 hover:scale-105'>Github Code</a>
                                <a href='/details' className='w-1/3 px-6 py-3  duration-200 hover:scale-105'>Details</a>
                            </div>
                        </div>
                        )
                    }
